class Atleta {
  ...
  // Método para calcular a média válida (desconsiderando a maior e a menor nota)
  calculaMediaValida() {
    ...
    let somaNotas = notasValidas.reduce((acc, nota) => acc + nota, 0);  // Soma as 3 notas válidas
    return somaNotas / notasValidas.length;  // Calcula a média
  }
